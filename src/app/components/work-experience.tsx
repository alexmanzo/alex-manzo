...
const experience: Array<Job> = [
  ...
  },
  {
    ...
    endDate: '2022',
    bullets: [
      'Enhanced frontend architecture and developer experience by refactoring a monorepo’s Webpack pipeline for faster builds, cutting several minute compile times for local development down to seconds.',
      'Introduced a customizable default CSS theme using Tailwind and custom properties, along with a dynamic UI for live theming, unlocking the ability for clients to build their own themes with no code for the first time.',
    ],
  },
  {
    ...
    endDate: '2021',
    bullets: [
      'Built custom Drupal themes from Figma designs for global health orgs.',
      'Shaped playful user experiences for Savas Labs and Labs microsite in line with their brand identity',
      'Created impactful side projects, including a gender-inclusive UX quiz and a 2020-themed lorem ipsum generator built in only a few days.',
    ],
  },
  {
    title: 'Web Developer',
    ...
    endDate: '2019',
    bullets: [
      'Worked closely with designers, developers, and content teams to maintain and enhance NIEHS websites.',
      'Provided QA for new team members and supported large projects with HTML, CSS, and JavaScript updates.',
      'Collaborated on multimedia efforts, creating graphics and video assets with Adobe tools to support cohesive, high-impact digital content.',
    ],
  },
];
